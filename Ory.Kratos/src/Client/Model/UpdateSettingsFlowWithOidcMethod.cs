...
namespace Client.Model
{
    ...
    public partial class UpdateSettingsFlowWithOidcMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSettingsFlowWithOidcMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateSettingsFlowWithOidcMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSettingsFlowWithOidcMethod" /> class.
        /// </summary>
        ...
        public UpdateSettingsFlowWithOidcMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), string unlink = default(string), Object upstreamParameters = default(Object))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateSettingsFlowWithOidcMethod and cannot be null");
            }
            this.Method = method;
            this.Flow = flow;
            this.Link = link;
