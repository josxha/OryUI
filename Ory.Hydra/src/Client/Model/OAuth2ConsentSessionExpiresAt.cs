...
namespace Client.Model
{
    ...
    public partial class OAuth2ConsentSessionExpiresAt : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2ConsentSessionExpiresAt" /> class.
        /// </summary>
        ...
        public OAuth2ConsentSessionExpiresAt(DateTime accessToken = default(DateTime), DateTime authorizeCode = default(DateTime), DateTime idToken = default(DateTime), DateTime parContext = default(DateTime), DateTime refreshToken = default(DateTime))
        {
