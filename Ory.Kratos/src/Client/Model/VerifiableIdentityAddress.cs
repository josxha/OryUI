...
namespace Client.Model
{
    ...
    public partial class VerifiableIdentityAddress : IValidatableObject
    {
        /// <summary>
        /// The delivery method
        /// </summary>
        ...
        protected VerifiableIdentityAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifiableIdentityAddress" /> class.
        /// </summary>
        ...
        public VerifiableIdentityAddress(DateTime createdAt = default(DateTime), string id = default(string), string status = default(string), DateTime updatedAt = default(DateTime), string value = default(string), bool verified = default(bool), DateTime verifiedAt = default(DateTime), ViaEnum via = default(ViaEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for VerifiableIdentityAddress and cannot be null");
            }
            this.Status = status;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for VerifiableIdentityAddress and cannot be null");
            }
            this.Value = value;
