...
namespace Client.Model
{
    ...
    public partial class UpdateRegistrationFlowWithWebAuthnMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRegistrationFlowWithWebAuthnMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRegistrationFlowWithWebAuthnMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRegistrationFlowWithWebAuthnMethod" /> class.
        /// </summary>
        ...
        public UpdateRegistrationFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), Object traits = default(Object), Object transientPayload = default(Object), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateRegistrationFlowWithWebAuthnMethod and cannot be null");
            }
            this.Method = method;
            // to ensure "traits" is required (not null)
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for UpdateRegistrationFlowWithWebAuthnMethod and cannot be null");
            }
            this.Traits = traits;
