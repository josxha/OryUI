...
namespace Client.Api
{
    ...
    public partial class CourierApi : ICourierApi
    {
        ...
        /// <returns></returns>
        public CourierApi(Client.Client.Configuration configuration)
        {
        ...
        public CourierApi(Client.Client.ISynchronousClient client, Client.Client.IAsynchronousClient asyncClient, Client.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Client.Client.ApiResponse<Message> localVarResponse = GetCourierMessageWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Message</returns>
        public Client.Client.ApiResponse<Message> GetCourierMessageWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Client.Client.ApiException(400, "Missing required parameter 'id' when calling CourierApi->GetCourierMessage");
            }
        ...
        {
            Client.Client.ApiResponse<Message> localVarResponse = await GetCourierMessageWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Message)</returns>
        public async System.Threading.Tasks.Task<Client.Client.ApiResponse<Message>> GetCourierMessageWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Client.Client.ApiResponse<List<Message>> localVarResponse = ListCourierMessagesWithHttpInfo(pageSize, pageToken, status, recipient);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Message&gt;</returns>
        public Client.Client.ApiResponse<List<Message>> ListCourierMessagesWithHttpInfo(long? pageSize = default(long?), string? pageToken = default(string?), CourierMessageStatus? status = default(CourierMessageStatus?), string? recipient = default(string?), int operationIndex = 0)
        {
            Client.Client.RequestOptions localVarRequestOptions = new Client.Client.RequestOptions();
            ...
            if (status != null)
            {
                localVarRequestOptions.QueryParameters.Add(Client.Client.ClientUtils.ParameterToMultiMap("", "status", status));
            }
            if (recipient != null)
            {
                localVarRequestOptions.QueryParameters.Add(Client.Client.ClientUtils.ParameterToMultiMap("", "recipient", recipient));
            }
        ...
        {
            Client.Client.ApiResponse<List<Message>> localVarResponse = await ListCourierMessagesWithHttpInfoAsync(pageSize, pageToken, status, recipient, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Message&gt;)</returns>
        public async System.Threading.Tasks.Task<Client.Client.ApiResponse<List<Message>>> ListCourierMessagesWithHttpInfoAsync(long? pageSize = default(long?), string? pageToken = default(string?), CourierMessageStatus? status = default(CourierMessageStatus?), string? recipient = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
