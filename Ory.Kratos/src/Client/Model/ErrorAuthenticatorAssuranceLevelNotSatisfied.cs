...
namespace Client.Model
{
    ...
    public partial class ErrorAuthenticatorAssuranceLevelNotSatisfied : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorAuthenticatorAssuranceLevelNotSatisfied" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="redirectBrowserTo">Points to where to redirect the user to next..</param>
        public ErrorAuthenticatorAssuranceLevelNotSatisfied(GenericError error = default(GenericError), string redirectBrowserTo = default(string))
        {
            this.Error = error;
