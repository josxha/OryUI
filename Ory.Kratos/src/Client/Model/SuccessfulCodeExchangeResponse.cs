...
namespace Client.Model
{
    ...
    public partial class SuccessfulCodeExchangeResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulCodeExchangeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuccessfulCodeExchangeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulCodeExchangeResponse" /> class.
        /// </summary>
        ...
        public SuccessfulCodeExchangeResponse(Session session = default(Session), string sessionToken = default(string))
        {
            // to ensure "session" is required (not null)
            if (session == null)
            {
                throw new ArgumentNullException("session is a required property for SuccessfulCodeExchangeResponse and cannot be null");
            }
