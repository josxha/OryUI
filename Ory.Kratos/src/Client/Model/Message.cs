...
namespace Client.Model
{
    ...
    public partial class Message : IValidatableObject
    {
        ...
        public CourierMessageStatus Status { get; set; }
        /// <summary>
        ...
        public CourierMessageType Type { get; set; }
        /// <summary>
        ...
        public Message(string body = default(string), string channel = default(string), DateTime createdAt = default(DateTime), List<MessageDispatch> dispatches = default(List<MessageDispatch>), string id = default(string), string recipient = default(string), long sendCount = default(long), CourierMessageStatus status = default(CourierMessageStatus), string subject = default(string), TemplateTypeEnum templateType = default(TemplateTypeEnum), CourierMessageType type = default(CourierMessageType), DateTime updatedAt = default(DateTime))
        {
            ...
            if (recipient == null)
            {
                throw new ArgumentNullException("recipient is a required property for Message and cannot be null");
            }
        ...
        public List<MessageDispatch> Dispatches { get; set; }
