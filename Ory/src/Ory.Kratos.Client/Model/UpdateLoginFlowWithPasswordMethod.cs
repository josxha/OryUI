...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UpdateLoginFlowWithPasswordMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithPasswordMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateLoginFlowWithPasswordMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithPasswordMethod" /> class.
        /// </summary>
        ...
        public UpdateLoginFlowWithPasswordMethod(string csrfToken = default(string), string identifier = default(string), string method = default(string), string password = default(string), string passwordIdentifier = default(string))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for UpdateLoginFlowWithPasswordMethod and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateLoginFlowWithPasswordMethod and cannot be null");
            }
            this.Method = method;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for UpdateLoginFlowWithPasswordMethod and cannot be null");
            }
