...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UpdateLoginFlowWithCodeMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithCodeMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateLoginFlowWithCodeMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithCodeMethod" /> class.
        /// </summary>
        ...
        public UpdateLoginFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string identifier = default(string), string method = default(string), string resend = default(string))
        {
            // to ensure "csrfToken" is required (not null)
            if (csrfToken == null)
            {
                throw new ArgumentNullException("csrfToken is a required property for UpdateLoginFlowWithCodeMethod and cannot be null");
            }
            this.CsrfToken = csrfToken;
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateLoginFlowWithCodeMethod and cannot be null");
            }
            this.Method = method;
            this.Code = code;
