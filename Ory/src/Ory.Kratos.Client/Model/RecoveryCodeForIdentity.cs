...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class RecoveryCodeForIdentity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryCodeForIdentity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecoveryCodeForIdentity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryCodeForIdentity" /> class.
        /// </summary>
        ...
        public RecoveryCodeForIdentity(DateTime expiresAt = default(DateTime), string recoveryCode = default(string), string recoveryLink = default(string))
        {
            // to ensure "recoveryCode" is required (not null)
            if (recoveryCode == null)
            {
                throw new ArgumentNullException("recoveryCode is a required property for RecoveryCodeForIdentity and cannot be null");
            }
            this.RecoveryCode = recoveryCode;
            // to ensure "recoveryLink" is required (not null)
            if (recoveryLink == null)
            {
                throw new ArgumentNullException("recoveryLink is a required property for RecoveryCodeForIdentity and cannot be null");
            }
