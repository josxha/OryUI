...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class IdentityCredentialsCode : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityCredentialsCode" /> class.
        /// </summary>
        /// <param name="addressType">The type of the address for this code.</param>
        /// <param name="usedAt">usedAt.</param>
        public IdentityCredentialsCode(string addressType = default(string), DateTime? usedAt = default(DateTime?))
        {
