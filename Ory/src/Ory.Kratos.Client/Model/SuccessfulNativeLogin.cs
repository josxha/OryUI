...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class SuccessfulNativeLogin : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulNativeLogin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuccessfulNativeLogin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulNativeLogin" /> class.
        /// </summary>
        ...
        public SuccessfulNativeLogin(Session session = default(Session), string sessionToken = default(string))
        {
            // to ensure "session" is required (not null)
            if (session == null)
            {
                throw new ArgumentNullException("session is a required property for SuccessfulNativeLogin and cannot be null");
            }
