...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class CreateRecoveryLinkForIdentityBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRecoveryLinkForIdentityBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRecoveryLinkForIdentityBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRecoveryLinkForIdentityBody" /> class.
        /// </summary>
        ...
        public CreateRecoveryLinkForIdentityBody(string expiresIn = default(string), string identityId = default(string))
        {
            // to ensure "identityId" is required (not null)
            if (identityId == null)
            {
                throw new ArgumentNullException("identityId is a required property for CreateRecoveryLinkForIdentityBody and cannot be null");
            }
