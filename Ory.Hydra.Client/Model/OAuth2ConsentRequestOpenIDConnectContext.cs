...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class OAuth2ConsentRequestOpenIDConnectContext : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2ConsentRequestOpenIDConnectContext" /> class.
        /// </summary>
        ...
        public OAuth2ConsentRequestOpenIDConnectContext(List<string> acrValues = default(List<string>), string display = default(string), Dictionary<string, Object> idTokenHintClaims = default(Dictionary<string, Object>), string loginHint = default(string), List<string> uiLocales = default(List<string>))
        {
