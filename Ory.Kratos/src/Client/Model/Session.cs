...
namespace Client.Model
{
    ...
    public partial class Session : IValidatableObject
    {
        ...
        public AuthenticatorAssuranceLevel? AuthenticatorAssuranceLevel { get; set; }
        /// <summary>
        ...
        public Session(bool active = default(bool), DateTime authenticatedAt = default(DateTime), List<SessionAuthenticationMethod> authenticationMethods = default(List<SessionAuthenticationMethod>), AuthenticatorAssuranceLevel? authenticatorAssuranceLevel = default(AuthenticatorAssuranceLevel?), List<SessionDevice> devices = default(List<SessionDevice>), DateTime expiresAt = default(DateTime), string id = default(string), Identity identity = default(Identity), DateTime issuedAt = default(DateTime), string tokenized = default(string))
        {
        ...
        public List<SessionAuthenticationMethod> AuthenticationMethods { get; set; }
        ...
        public List<SessionDevice> Devices { get; set; }
