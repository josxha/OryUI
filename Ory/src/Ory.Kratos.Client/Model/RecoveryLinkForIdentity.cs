...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class RecoveryLinkForIdentity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryLinkForIdentity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecoveryLinkForIdentity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryLinkForIdentity" /> class.
        /// </summary>
        ...
        public RecoveryLinkForIdentity(DateTime expiresAt = default(DateTime), string recoveryLink = default(string))
        {
            // to ensure "recoveryLink" is required (not null)
            if (recoveryLink == null)
            {
                throw new ArgumentNullException("recoveryLink is a required property for RecoveryLinkForIdentity and cannot be null");
            }
