...
namespace Client.Model
{
    ...
    public partial class OAuth2ConsentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2ConsentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OAuth2ConsentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2ConsentRequest" /> class.
        /// </summary>
        ...
        public OAuth2ConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), OAuth2Client varClient = default(OAuth2Client), Object context = default(Object), string loginChallenge = default(string), string loginSessionId = default(string), OAuth2ConsentRequestOpenIDConnectContext oidcContext = default(OAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
            // to ensure "challenge" is required (not null)
            if (challenge == null)
            {
                throw new ArgumentNullException("challenge is a required property for OAuth2ConsentRequest and cannot be null");
            }
