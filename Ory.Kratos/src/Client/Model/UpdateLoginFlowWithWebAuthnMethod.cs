...
namespace Client.Model
{
    ...
    public partial class UpdateLoginFlowWithWebAuthnMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithWebAuthnMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateLoginFlowWithWebAuthnMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithWebAuthnMethod" /> class.
        /// </summary>
        ...
        public UpdateLoginFlowWithWebAuthnMethod(string csrfToken = default(string), string identifier = default(string), string method = default(string), string webauthnLogin = default(string))
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for UpdateLoginFlowWithWebAuthnMethod and cannot be null");
            }
            this.Identifier = identifier;
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateLoginFlowWithWebAuthnMethod and cannot be null");
            }
            this.Method = method;
