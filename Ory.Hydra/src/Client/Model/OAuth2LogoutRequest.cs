...
namespace Client.Model
{
    ...
    public partial class OAuth2LogoutRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2LogoutRequest" /> class.
        /// </summary>
        ...
        public OAuth2LogoutRequest(string challenge = default(string), OAuth2Client varClient = default(OAuth2Client), string requestUrl = default(string), bool rpInitiated = default(bool), string sid = default(string), string subject = default(string))
        {
