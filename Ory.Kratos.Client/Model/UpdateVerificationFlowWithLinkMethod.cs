...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UpdateVerificationFlowWithLinkMethod : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateVerificationFlowWithLinkMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateVerificationFlowWithLinkMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateVerificationFlowWithLinkMethod" /> class.
        /// </summary>
        ...
        public UpdateVerificationFlowWithLinkMethod(string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for UpdateVerificationFlowWithLinkMethod and cannot be null");
            }
            this.Email = email;
            this.Method = method;
