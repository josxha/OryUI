...
namespace Client.Model
{
    ...
    public partial class VerifiableCredentialResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifiableCredentialResponse" /> class.
        /// </summary>
        /// <param name="credentialDraft00">credentialDraft00.</param>
        /// <param name="format">format.</param>
        public VerifiableCredentialResponse(string credentialDraft00 = default(string), string format = default(string))
        {
