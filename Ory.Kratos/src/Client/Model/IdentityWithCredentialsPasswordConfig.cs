...
namespace Client.Model
{
    ...
    public partial class IdentityWithCredentialsPasswordConfig : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityWithCredentialsPasswordConfig" /> class.
        /// </summary>
        ...
        public IdentityWithCredentialsPasswordConfig(string hashedPassword = default(string), string password = default(string))
        {
