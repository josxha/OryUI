...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class TokenPaginationHeaders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenPaginationHeaders" /> class.
        /// </summary>
        ...
        public TokenPaginationHeaders(string link = default(string), string xTotalCount = default(string))
        {
            this.Link = link;
