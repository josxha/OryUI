...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class OidcConfiguration : IValidatableObject
    {
        ...
        public OidcConfiguration(string authorizationEndpoint = default(string), bool backchannelLogoutSessionSupported = default(bool), bool backchannelLogoutSupported = default(bool), bool claimsParameterSupported = default(bool), List<string> claimsSupported = default(List<string>), List<string> codeChallengeMethodsSupported = default(List<string>), string credentialsEndpointDraft00 = default(string), List<CredentialSupportedDraft00> credentialsSupportedDraft00 = default(List<CredentialSupportedDraft00>), string endSessionEndpoint = default(string), bool frontchannelLogoutSessionSupported = default(bool), bool frontchannelLogoutSupported = default(bool), List<string> grantTypesSupported = default(List<string>), List<string> idTokenSignedResponseAlg = default(List<string>), List<string> idTokenSigningAlgValuesSupported = default(List<string>), string issuer = default(string), string jwksUri = default(string), string registrationEndpoint = default(string), List<string> requestObjectSigningAlgValuesSupported = default(List<string>), bool requestParameterSupported = default(bool), bool requestUriParameterSupported = default(bool), bool requireRequestUriRegistration = default(bool), List<string> responseModesSupported = default(List<string>), List<string> responseTypesSupported = default(List<string>), string revocationEndpoint = default(string), List<string> scopesSupported = default(List<string>), List<string> subjectTypesSupported = default(List<string>), string tokenEndpoint = default(string), List<string> tokenEndpointAuthMethodsSupported = default(List<string>), string userinfoEndpoint = default(string), List<string> userinfoSignedResponseAlg = default(List<string>), List<string> userinfoSigningAlgValuesSupported = default(List<string>))
        {
            // to ensure "authorizationEndpoint" is required (not null)
            if (authorizationEndpoint == null)
            {
                throw new ArgumentNullException("authorizationEndpoint is a required property for OidcConfiguration and cannot be null");
            }
            this.AuthorizationEndpoint = authorizationEndpoint;
            // to ensure "idTokenSignedResponseAlg" is required (not null)
            if (idTokenSignedResponseAlg == null)
            {
                throw new ArgumentNullException("idTokenSignedResponseAlg is a required property for OidcConfiguration and cannot be null");
            }
            this.IdTokenSignedResponseAlg = idTokenSignedResponseAlg;
            // to ensure "idTokenSigningAlgValuesSupported" is required (not null)
            if (idTokenSigningAlgValuesSupported == null)
            {
                throw new ArgumentNullException("idTokenSigningAlgValuesSupported is a required property for OidcConfiguration and cannot be null");
            }
            this.IdTokenSigningAlgValuesSupported = idTokenSigningAlgValuesSupported;
            // to ensure "issuer" is required (not null)
            if (issuer == null)
            {
                throw new ArgumentNullException("issuer is a required property for OidcConfiguration and cannot be null");
            }
            this.Issuer = issuer;
            // to ensure "jwksUri" is required (not null)
            if (jwksUri == null)
            {
                throw new ArgumentNullException("jwksUri is a required property for OidcConfiguration and cannot be null");
            }
            this.JwksUri = jwksUri;
            // to ensure "responseTypesSupported" is required (not null)
            if (responseTypesSupported == null)
            {
                throw new ArgumentNullException("responseTypesSupported is a required property for OidcConfiguration and cannot be null");
            }
            this.ResponseTypesSupported = responseTypesSupported;
            // to ensure "subjectTypesSupported" is required (not null)
            if (subjectTypesSupported == null)
            {
                throw new ArgumentNullException("subjectTypesSupported is a required property for OidcConfiguration and cannot be null");
            }
            this.SubjectTypesSupported = subjectTypesSupported;
            // to ensure "tokenEndpoint" is required (not null)
            if (tokenEndpoint == null)
            {
                throw new ArgumentNullException("tokenEndpoint is a required property for OidcConfiguration and cannot be null");
            }
            this.TokenEndpoint = tokenEndpoint;
            // to ensure "userinfoSignedResponseAlg" is required (not null)
            if (userinfoSignedResponseAlg == null)
            {
                throw new ArgumentNullException("userinfoSignedResponseAlg is a required property for OidcConfiguration and cannot be null");
            }
        ...
        public List<CredentialSupportedDraft00> CredentialsSupportedDraft00 { get; set; }
