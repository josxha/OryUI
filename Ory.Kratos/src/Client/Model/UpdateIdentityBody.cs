...
namespace Client.Model
{
    ...
    public partial class UpdateIdentityBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateIdentityBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateIdentityBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateIdentityBody" /> class.
        /// </summary>
        ...
        public UpdateIdentityBody(IdentityWithCredentials credentials = default(IdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), string schemaId = default(string), StateEnum state = default(StateEnum), Object traits = default(Object))
        {
            // to ensure "schemaId" is required (not null)
            if (schemaId == null)
            {
                throw new ArgumentNullException("schemaId is a required property for UpdateIdentityBody and cannot be null");
            }
            ...
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for UpdateIdentityBody and cannot be null");
            }
            this.Traits = traits;
