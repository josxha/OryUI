...
namespace Client.Model
{
    ...
    public partial class VerifiableCredentialPrimingResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifiableCredentialPrimingResponse" /> class.
        /// </summary>
        ...
        public VerifiableCredentialPrimingResponse(string cNonce = default(string), long cNonceExpiresIn = default(long), string error = default(string), string errorDebug = default(string), string errorDescription = default(string), string errorHint = default(string), string format = default(string), long statusCode = default(long))
        {
            this.CNonce = cNonce;
