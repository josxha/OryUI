...
namespace Client.Model
{
    ...
    public partial class AcceptOAuth2LoginRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptOAuth2LoginRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AcceptOAuth2LoginRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptOAuth2LoginRequest" /> class.
        /// </summary>
        ...
        public AcceptOAuth2LoginRequest(string acr = default(string), List<string> amr = default(List<string>), Object context = default(Object), bool extendSessionLifespan = default(bool), string forceSubjectIdentifier = default(string), string identityProviderSessionId = default(string), bool remember = default(bool), long rememberFor = default(long), string subject = default(string))
        {
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for AcceptOAuth2LoginRequest and cannot be null");
            }
