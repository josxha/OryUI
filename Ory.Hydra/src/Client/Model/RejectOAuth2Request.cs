...
namespace Client.Model
{
    ...
    public partial class RejectOAuth2Request : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RejectOAuth2Request" /> class.
        /// </summary>
        ...
        public RejectOAuth2Request(string error = default(string), string errorDebug = default(string), string errorDescription = default(string), string errorHint = default(string), long statusCode = default(long))
        {
            this.Error = error;
