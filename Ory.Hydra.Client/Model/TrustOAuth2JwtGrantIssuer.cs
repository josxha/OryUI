...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class TrustOAuth2JwtGrantIssuer : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustOAuth2JwtGrantIssuer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrustOAuth2JwtGrantIssuer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustOAuth2JwtGrantIssuer" /> class.
        /// </summary>
        ...
        public TrustOAuth2JwtGrantIssuer(bool allowAnySubject = default(bool), DateTime expiresAt = default(DateTime), string issuer = default(string), JsonWebKey jwk = default(JsonWebKey), List<string> scope = default(List<string>), string subject = default(string))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "issuer" is required (not null)
            if (issuer == null)
            {
                throw new ArgumentNullException("issuer is a required property for TrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Issuer = issuer;
            // to ensure "jwk" is required (not null)
            if (jwk == null)
            {
                throw new ArgumentNullException("jwk is a required property for TrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Jwk = jwk;
            // to ensure "scope" is required (not null)
            if (scope == null)
            {
                throw new ArgumentNullException("scope is a required property for TrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Scope = scope;
