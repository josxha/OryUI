...
namespace Client.Model
{
    ...
    public partial class UpdateLoginFlowWithOidcMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithOidcMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateLoginFlowWithOidcMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithOidcMethod" /> class.
        /// </summary>
        ...
        public UpdateLoginFlowWithOidcMethod(string csrfToken = default(string), string idToken = default(string), string idTokenNonce = default(string), string method = default(string), string provider = default(string), Object traits = default(Object), Object upstreamParameters = default(Object))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateLoginFlowWithOidcMethod and cannot be null");
            }
            this.Method = method;
            // to ensure "provider" is required (not null)
            if (provider == null)
            {
                throw new ArgumentNullException("provider is a required property for UpdateLoginFlowWithOidcMethod and cannot be null");
            }
