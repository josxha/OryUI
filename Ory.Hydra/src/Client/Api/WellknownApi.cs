...
namespace Client.Api
{
    ...
    public interface IWellknownApiSync : IApiAccessor
    {
        ...
        JsonWebKeySet DiscoverJsonWebKeys(int operationIndex = 0);
        ...
        ApiResponse<JsonWebKeySet> DiscoverJsonWebKeysWithHttpInfo(int operationIndex = 0);
    ...
    public interface IWellknownApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<JsonWebKeySet> DiscoverJsonWebKeysAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<JsonWebKeySet>> DiscoverJsonWebKeysWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class WellknownApi : IWellknownApi
    {
        ...
        /// <returns></returns>
        public WellknownApi(Client.Client.Configuration configuration)
        {
        ...
        public WellknownApi(Client.Client.ISynchronousClient client, Client.Client.IAsynchronousClient asyncClient, Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>JsonWebKeySet</returns>
        public JsonWebKeySet DiscoverJsonWebKeys(int operationIndex = 0)
        {
            Client.Client.ApiResponse<JsonWebKeySet> localVarResponse = DiscoverJsonWebKeysWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of JsonWebKeySet</returns>
        public Client.Client.ApiResponse<JsonWebKeySet> DiscoverJsonWebKeysWithHttpInfo(int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<JsonWebKeySet>("/.well-known/jwks.json", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JsonWebKeySet</returns>
        public async System.Threading.Tasks.Task<JsonWebKeySet> DiscoverJsonWebKeysAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Client.Client.ApiResponse<JsonWebKeySet> localVarResponse = await DiscoverJsonWebKeysWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (JsonWebKeySet)</returns>
        public async System.Threading.Tasks.Task<Client.Client.ApiResponse<JsonWebKeySet>> DiscoverJsonWebKeysWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<JsonWebKeySet>("/.well-known/jwks.json", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
