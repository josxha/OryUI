...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UiNodeScriptAttributes : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeScriptAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UiNodeScriptAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeScriptAttributes" /> class.
        /// </summary>
        ...
        public UiNodeScriptAttributes(bool async = default(bool), string crossorigin = default(string), string id = default(string), string integrity = default(string), string nodeType = default(string), string nonce = default(string), string referrerpolicy = default(string), string src = default(string), string type = default(string))
        {
            this.Async = async;
            // to ensure "crossorigin" is required (not null)
            if (crossorigin == null)
            {
                throw new ArgumentNullException("crossorigin is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Crossorigin = crossorigin;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Id = id;
            // to ensure "integrity" is required (not null)
            if (integrity == null)
            {
                throw new ArgumentNullException("integrity is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Integrity = integrity;
            // to ensure "nodeType" is required (not null)
            if (nodeType == null)
            {
                throw new ArgumentNullException("nodeType is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.NodeType = nodeType;
            // to ensure "nonce" is required (not null)
            if (nonce == null)
            {
                throw new ArgumentNullException("nonce is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Nonce = nonce;
            // to ensure "referrerpolicy" is required (not null)
            if (referrerpolicy == null)
            {
                throw new ArgumentNullException("referrerpolicy is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Referrerpolicy = referrerpolicy;
            // to ensure "src" is required (not null)
            if (src == null)
            {
                throw new ArgumentNullException("src is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Src = src;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for UiNodeScriptAttributes and cannot be null");
            }
            this.Type = type;
        }
