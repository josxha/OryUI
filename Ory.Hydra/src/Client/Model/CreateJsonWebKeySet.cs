...
namespace Client.Model
{
    ...
    public partial class CreateJsonWebKeySet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateJsonWebKeySet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateJsonWebKeySet() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateJsonWebKeySet" /> class.
        /// </summary>
        ...
        public CreateJsonWebKeySet(string alg = default(string), string kid = default(string), string use = default(string))
        {
            // to ensure "alg" is required (not null)
            if (alg == null)
            {
                throw new ArgumentNullException("alg is a required property for CreateJsonWebKeySet and cannot be null");
            }
            this.Alg = alg;
            // to ensure "kid" is required (not null)
            if (kid == null)
            {
                throw new ArgumentNullException("kid is a required property for CreateJsonWebKeySet and cannot be null");
            }
            this.Kid = kid;
            // to ensure "use" is required (not null)
            if (use == null)
            {
                throw new ArgumentNullException("use is a required property for CreateJsonWebKeySet and cannot be null");
            }
            this.Use = use;
        }
