...
namespace Client.Model
{
    ...
    public partial class OAuth2ConsentSession : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2ConsentSession" /> class.
        /// </summary>
        ...
        public OAuth2ConsentSession(OAuth2ConsentRequest consentRequest = default(OAuth2ConsentRequest), Object context = default(Object), OAuth2ConsentSessionExpiresAt expiresAt = default(OAuth2ConsentSessionExpiresAt), List<string> grantAccessTokenAudience = default(List<string>), List<string> grantScope = default(List<string>), DateTime handledAt = default(DateTime), bool remember = default(bool), long rememberFor = default(long), AcceptOAuth2ConsentRequestSession session = default(AcceptOAuth2ConsentRequestSession))
        {
        ...
        public OAuth2ConsentRequest ConsentRequest { get; set; }
        ...
        public OAuth2ConsentSessionExpiresAt ExpiresAt { get; set; }
        ...
        public AcceptOAuth2ConsentRequestSession Session { get; set; }
