...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UpdateRecoveryFlowWithLinkMethod : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRecoveryFlowWithLinkMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRecoveryFlowWithLinkMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRecoveryFlowWithLinkMethod" /> class.
        /// </summary>
        ...
        public UpdateRecoveryFlowWithLinkMethod(string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for UpdateRecoveryFlowWithLinkMethod and cannot be null");
            }
            this.Email = email;
            this.Method = method;
