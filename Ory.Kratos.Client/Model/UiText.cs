...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UiText : IValidatableObject
    {
        /// <summary>
        ...
        public UiText(Object context = default(Object), long id = default(long), string text = default(string), TypeEnum type = default(TypeEnum))
        {
            this.Id = id;
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for UiText and cannot be null");
            }
            this.Text = text;
            this.Type = type;
