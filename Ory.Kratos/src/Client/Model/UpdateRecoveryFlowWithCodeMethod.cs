...
namespace Client.Model
{
    ...
    public partial class UpdateRecoveryFlowWithCodeMethod : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRecoveryFlowWithCodeMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRecoveryFlowWithCodeMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRecoveryFlowWithCodeMethod" /> class.
        /// </summary>
        ...
        public UpdateRecoveryFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            this.Method = method;
            this.Code = code;
