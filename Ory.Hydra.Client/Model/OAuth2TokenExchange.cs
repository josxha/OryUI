...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class OAuth2TokenExchange : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuth2TokenExchange" /> class.
        /// </summary>
        ...
        public OAuth2TokenExchange(string accessToken = default(string), long expiresIn = default(long), string idToken = default(string), string refreshToken = default(string), string scope = default(string), string tokenType = default(string))
        {
