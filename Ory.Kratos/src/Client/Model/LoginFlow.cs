...
namespace Client.Model
{
    ...
    public partial class LoginFlow : IValidatableObject
    {
        /// <summary>
        ...
        public AuthenticatorAssuranceLevel? RequestedAal { get; set; }
        /// <summary>
        ...
        public LoginFlow(ActiveEnum? active = default(ActiveEnum?), DateTime createdAt = default(DateTime), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string oauth2LoginChallenge = default(string), OAuth2LoginRequest oauth2LoginRequest = default(OAuth2LoginRequest), string organizationId = default(string), bool refresh = default(bool), string requestUrl = default(string), AuthenticatorAssuranceLevel? requestedAal = default(AuthenticatorAssuranceLevel?), string returnTo = default(string), string sessionTokenExchangeCode = default(string), Object state = default(Object), string type = default(string), UiContainer ui = default(UiContainer), DateTime updatedAt = default(DateTime))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for LoginFlow and cannot be null");
            }
            this.Id = id;
            ...
            if (requestUrl == null)
            {
                throw new ArgumentNullException("requestUrl is a required property for LoginFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for LoginFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for LoginFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null)
            {
                throw new ArgumentNullException("ui is a required property for LoginFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
        ...
        public OAuth2LoginRequest Oauth2LoginRequest { get; set; }
