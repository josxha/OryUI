...
namespace Ory.Hydra.Client.Api
{
    ...
    public partial class WellknownApi : IWellknownApi
    {
        ...
        {
            Ory.Hydra.Client.Client.ApiResponse<JsonWebKeySet> localVarResponse = DiscoverJsonWebKeysWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of JsonWebKeySet</returns>
        public Ory.Hydra.Client.Client.ApiResponse<JsonWebKeySet> DiscoverJsonWebKeysWithHttpInfo(int operationIndex = 0)
        {
        ...
        {
            Ory.Hydra.Client.Client.ApiResponse<JsonWebKeySet> localVarResponse = await DiscoverJsonWebKeysWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (JsonWebKeySet)</returns>
        public async System.Threading.Tasks.Task<Ory.Hydra.Client.Client.ApiResponse<JsonWebKeySet>> DiscoverJsonWebKeysWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
