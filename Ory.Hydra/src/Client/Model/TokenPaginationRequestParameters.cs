...
namespace Client.Model
{
    ...
    public partial class TokenPaginationRequestParameters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenPaginationRequestParameters" /> class.
        /// </summary>
        ...
        public TokenPaginationRequestParameters(long pageSize = 250, string pageToken = @"1")
        {
