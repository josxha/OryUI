...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UpdateLoginFlowWithLookupSecretMethod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithLookupSecretMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateLoginFlowWithLookupSecretMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateLoginFlowWithLookupSecretMethod" /> class.
        /// </summary>
        ...
        public UpdateLoginFlowWithLookupSecretMethod(string csrfToken = default(string), string lookupSecret = default(string), string method = default(string))
        {
            // to ensure "lookupSecret" is required (not null)
            if (lookupSecret == null)
            {
                throw new ArgumentNullException("lookupSecret is a required property for UpdateLoginFlowWithLookupSecretMethod and cannot be null");
            }
            this.LookupSecret = lookupSecret;
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for UpdateLoginFlowWithLookupSecretMethod and cannot be null");
            }
            this.Method = method;
