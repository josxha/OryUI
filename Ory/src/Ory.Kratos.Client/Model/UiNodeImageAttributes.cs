...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UiNodeImageAttributes : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeImageAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UiNodeImageAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeImageAttributes" /> class.
        /// </summary>
        ...
        public UiNodeImageAttributes(long height = default(long), string id = default(string), string nodeType = default(string), string src = default(string), long width = default(long))
        {
            this.Height = height;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for UiNodeImageAttributes and cannot be null");
            }
            this.Id = id;
            // to ensure "nodeType" is required (not null)
            if (nodeType == null)
            {
                throw new ArgumentNullException("nodeType is a required property for UiNodeImageAttributes and cannot be null");
            }
            this.NodeType = nodeType;
            // to ensure "src" is required (not null)
            if (src == null)
            {
                throw new ArgumentNullException("src is a required property for UiNodeImageAttributes and cannot be null");
            }
            this.Src = src;
            this.Width = width;
        }
