...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class TokenPagination : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenPagination" /> class.
        /// </summary>
        ...
        public TokenPagination(long pageSize = 250, string pageToken = @"1")
        {
