...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class UiNodeInputAttributes : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeInputAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UiNodeInputAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UiNodeInputAttributes" /> class.
        /// </summary>
        ...
        public UiNodeInputAttributes(AutocompleteEnum? autocomplete = default(AutocompleteEnum?), bool disabled = default(bool), UiText label = default(UiText), string name = default(string), string nodeType = default(string), string onclick = default(string), string pattern = default(string), bool required = default(bool), TypeEnum type = default(TypeEnum), Object value = default(Object))
        {
            this.Disabled = disabled;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UiNodeInputAttributes and cannot be null");
            }
            this.Name = name;
            // to ensure "nodeType" is required (not null)
            if (nodeType == null)
            {
                throw new ArgumentNullException("nodeType is a required property for UiNodeInputAttributes and cannot be null");
            }
