...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class RegistrationFlow : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistrationFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RegistrationFlow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistrationFlow" /> class.
        /// </summary>
        ...
        public RegistrationFlow(ActiveEnum? active = default(ActiveEnum?), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string oauth2LoginChallenge = default(string), OAuth2LoginRequest oauth2LoginRequest = default(OAuth2LoginRequest), string organizationId = default(string), string requestUrl = default(string), string returnTo = default(string), string sessionTokenExchangeCode = default(string), Object state = default(Object), Object transientPayload = default(Object), string type = default(string), UiContainer ui = default(UiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for RegistrationFlow and cannot be null");
            }
            this.Id = id;
            ...
            if (requestUrl == null)
            {
                throw new ArgumentNullException("requestUrl is a required property for RegistrationFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for RegistrationFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for RegistrationFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null)
            {
                throw new ArgumentNullException("ui is a required property for RegistrationFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
