...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class PaginationHeaders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationHeaders" /> class.
        /// </summary>
        ...
        public PaginationHeaders(string link = default(string), string xTotalCount = default(string))
        {
            this.Link = link;
