...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class SuccessfulNativeRegistration : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulNativeRegistration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SuccessfulNativeRegistration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessfulNativeRegistration" /> class.
        /// </summary>
        ...
        public SuccessfulNativeRegistration(List<ContinueWith> continueWith = default(List<ContinueWith>), Identity identity = default(Identity), Session session = default(Session), string sessionToken = default(string))
        {
            // to ensure "identity" is required (not null)
            if (identity == null)
            {
                throw new ArgumentNullException("identity is a required property for SuccessfulNativeRegistration and cannot be null");
            }
