...
namespace Client.Model
{
    ...
    public partial class IdentityCredentials : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityCredentials" /> class.
        /// </summary>
        ...
        public IdentityCredentials(Object config = default(Object), DateTime createdAt = default(DateTime), List<string> identifiers = default(List<string>), TypeEnum? type = default(TypeEnum?), DateTime updatedAt = default(DateTime), long varVersion = default(long))
        {
            this.Config = config;
