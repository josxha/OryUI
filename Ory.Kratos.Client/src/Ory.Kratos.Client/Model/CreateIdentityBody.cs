...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class CreateIdentityBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIdentityBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateIdentityBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIdentityBody" /> class.
        /// </summary>
        ...
        public CreateIdentityBody(IdentityWithCredentials credentials = default(IdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), List<RecoveryIdentityAddress> recoveryAddresses = default(List<RecoveryIdentityAddress>), string schemaId = default(string), StateEnum? state = default(StateEnum?), Object traits = default(Object), List<VerifiableIdentityAddress> verifiableAddresses = default(List<VerifiableIdentityAddress>))
        {
            // to ensure "schemaId" is required (not null)
            if (schemaId == null)
            {
                throw new ArgumentNullException("schemaId is a required property for CreateIdentityBody and cannot be null");
            }
            this.SchemaId = schemaId;
            // to ensure "traits" is required (not null)
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for CreateIdentityBody and cannot be null");
            }
            this.Traits = traits;
        ...
        public IdentityWithCredentials Credentials { get; set; }
