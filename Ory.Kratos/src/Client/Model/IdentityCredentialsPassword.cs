...
namespace Client.Model
{
    ...
    public partial class IdentityCredentialsPassword : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityCredentialsPassword" /> class.
        /// </summary>
        /// <param name="hashedPassword">HashedPassword is a hash-representation of the password..</param>
        public IdentityCredentialsPassword(string hashedPassword = default(string))
        {
