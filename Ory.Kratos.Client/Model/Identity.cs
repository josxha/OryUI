...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class Identity : IValidatableObject
    {
        ...
        public Identity(DateTime createdAt = default(DateTime), Dictionary<string, IdentityCredentials> credentials = default(Dictionary<string, IdentityCredentials>), string id = default(string), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), string organizationId = default(string), List<RecoveryIdentityAddress> recoveryAddresses = default(List<RecoveryIdentityAddress>), string schemaId = default(string), string schemaUrl = default(string), StateEnum? state = default(StateEnum?), DateTime stateChangedAt = default(DateTime), Object traits = default(Object), DateTime updatedAt = default(DateTime), List<VerifiableIdentityAddress> verifiableAddresses = default(List<VerifiableIdentityAddress>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Identity and cannot be null");
            }
            this.Id = id;
            // to ensure "schemaId" is required (not null)
            if (schemaId == null)
            {
                throw new ArgumentNullException("schemaId is a required property for Identity and cannot be null");
            }
            this.SchemaId = schemaId;
            // to ensure "schemaUrl" is required (not null)
            if (schemaUrl == null)
            {
                throw new ArgumentNullException("schemaUrl is a required property for Identity and cannot be null");
            }
            this.SchemaUrl = schemaUrl;
            // to ensure "traits" is required (not null)
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for Identity and cannot be null");
            }
            this.Traits = traits;
        ...
        public Dictionary<string, IdentityCredentials> Credentials { get; set; }
