...
namespace Client.Model
{
    ...
    public partial class BatchPatchIdentitiesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchPatchIdentitiesResponse" /> class.
        /// </summary>
        /// <param name="identities">The patch responses for the individual identities..</param>
        public BatchPatchIdentitiesResponse(List<IdentityPatchResponse> identities = default(List<IdentityPatchResponse>))
        {
        ...
        public List<IdentityPatchResponse> Identities { get; set; }
