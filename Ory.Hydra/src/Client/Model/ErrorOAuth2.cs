...
namespace Client.Model
{
    ...
    public partial class ErrorOAuth2 : IValidatableObject
    {
        ...
        public ErrorOAuth2(string error = default(string), string errorDebug = default(string), string errorDescription = default(string), string errorHint = default(string), long statusCode = default(long))
        {
            this.Error = error;
