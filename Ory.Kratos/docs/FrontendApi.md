...
{
    // Get My Active Sessions
    ApiResponse<List<Session>> response = apiInstance.ListMySessionsWithHttpInfo(perPage, page, pageSize, pageToken, xSessionToken, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **UpdateRecoveryFlow**
> RecoveryFlow UpdateRecoveryFlow (string flow, UpdateRecoveryFlowBody updateRecoveryFlowBody, string? token = null, string? cookie = null)
...
namespace Example
{
    public class UpdateRecoveryFlowExample
    {
        public static void Main()
        {
            ...
            var updateRecoveryFlowBody = new UpdateRecoveryFlowBody(); // UpdateRecoveryFlowBody | 
...
{
    // Update Recovery Flow
    ApiResponse<RecoveryFlow> response = apiInstance.UpdateRecoveryFlowWithHttpInfo(flow, updateRecoveryFlowBody, token, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> SuccessfulNativeRegistration UpdateRegistrationFlow (string flow, UpdateRegistrationFlowBody updateRegistrationFlowBody, string? cookie = null)
...
namespace Example
{
    public class UpdateRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            var updateRegistrationFlowBody = new UpdateRegistrationFlowBody(); // UpdateRegistrationFlowBody | 
            var cookie = "cookie_example";  // string? | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional) 
...
{
    // Update Registration Flow
    ApiResponse<SuccessfulNativeRegistration> response = apiInstance.UpdateRegistrationFlowWithHttpInfo(flow, updateRegistrationFlowBody, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
# **UpdateSettingsFlow**
> SettingsFlow UpdateSettingsFlow (string flow, UpdateSettingsFlowBody updateSettingsFlowBody, string? xSessionToken = null, string? cookie = null)
...
namespace Example
{
    public class UpdateSettingsFlowExample
    {
        public static void Main()
        {
            ...
            var updateSettingsFlowBody = new UpdateSettingsFlowBody(); // UpdateSettingsFlowBody | 
            var xSessionToken = "xSessionToken_example";  // string? | The Session Token of the Identity performing the settings flow. (optional) 
            var cookie = "cookie_example";  // string? | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional) 
...
{
    // Complete Settings Flow
    ApiResponse<SettingsFlow> response = apiInstance.UpdateSettingsFlowWithHttpInfo(flow, updateSettingsFlowBody, xSessionToken, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> VerificationFlow UpdateVerificationFlow (string flow, UpdateVerificationFlowBody updateVerificationFlowBody, string? token = null, string? cookie = null)
...
namespace Example
{
    public class UpdateVerificationFlowExample
    {
        public static void Main()
        {
            ...
            var updateVerificationFlowBody = new UpdateVerificationFlowBody(); // UpdateVerificationFlowBody | 
...
{
    // Complete Verification Flow
    ApiResponse<VerificationFlow> response = apiInstance.UpdateVerificationFlowWithHttpInfo(flow, updateVerificationFlowBody, token, cookie);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
