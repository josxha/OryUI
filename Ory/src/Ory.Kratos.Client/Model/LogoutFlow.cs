...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class LogoutFlow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogoutFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LogoutFlow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LogoutFlow" /> class.
        /// </summary>
        ...
        public LogoutFlow(string logoutToken = default(string), string logoutUrl = default(string))
        {
            // to ensure "logoutToken" is required (not null)
            if (logoutToken == null)
            {
                throw new ArgumentNullException("logoutToken is a required property for LogoutFlow and cannot be null");
            }
            this.LogoutToken = logoutToken;
            // to ensure "logoutUrl" is required (not null)
            if (logoutUrl == null)
            {
                throw new ArgumentNullException("logoutUrl is a required property for LogoutFlow and cannot be null");
            }
