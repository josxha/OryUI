...
openapi-generator-cli.cmd generate -i "openapi-hydra.json" -g csharp -o "Ory.Hydra" --additional-properties=nullableReferenceTypes=true,packageName=Ory.Hydra.Client,packageVersion=2.2.0,netCoreProjectFile=true,sourceFolder=.
