...
namespace Client.Model
{
    ...
    public partial class IdentityPatch : IValidatableObject
    {
        /// <summary>
        ...
        public IdentityPatch(CreateIdentityBody create = default(CreateIdentityBody), string patchId = default(string))
        {
            this.Create = create;
        ...
        public CreateIdentityBody Create { get; set; }
