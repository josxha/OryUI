...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class TokenPaginationResponseHeaders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenPaginationResponseHeaders" /> class.
        /// </summary>
        ...
        public TokenPaginationResponseHeaders(string link = default(string), long xTotalCount = default(long))
        {
            this.Link = link;
