...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class SettingsFlow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SettingsFlow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingsFlow" /> class.
        /// </summary>
        ...
        public SettingsFlow(string active = default(string), List<ContinueWith> continueWith = default(List<ContinueWith>), DateTime expiresAt = default(DateTime), string id = default(string), Identity identity = default(Identity), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string returnTo = default(string), Object state = default(Object), string type = default(string), UiContainer ui = default(UiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SettingsFlow and cannot be null");
            }
            this.Id = id;
            // to ensure "identity" is required (not null)
            if (identity == null)
            {
                throw new ArgumentNullException("identity is a required property for SettingsFlow and cannot be null");
            }
            ...
            if (requestUrl == null)
            {
                throw new ArgumentNullException("requestUrl is a required property for SettingsFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for SettingsFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for SettingsFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null)
            {
                throw new ArgumentNullException("ui is a required property for SettingsFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
        ...
        public List<ContinueWith> ContinueWith { get; set; }
