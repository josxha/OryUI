...
namespace Client.Test.Api
{
    ...
    public class OAuth2ApiTests : IDisposable
    {
        ...
        public void AcceptOAuth2ConsentRequestTest()
        {
            ...
            //var response = instance.AcceptOAuth2ConsentRequest(consentChallenge, acceptOAuth2ConsentRequest);
            //Assert.IsType<OAuth2RedirectTo>(response);
        }
        ...
        public void AcceptOAuth2LoginRequestTest()
        {
            ...
            //var response = instance.AcceptOAuth2LoginRequest(loginChallenge, acceptOAuth2LoginRequest);
            //Assert.IsType<OAuth2RedirectTo>(response);
        }
        ...
        public void CreateOAuth2ClientTest()
        {
            ...
            //var response = instance.CreateOAuth2Client(oAuth2Client);
        ...
        public void GetOAuth2ConsentRequestTest()
        {
            ...
            //Assert.IsType<OAuth2ConsentRequest>(response);
        }
        ...
        public void GetOAuth2LoginRequestTest()
        {
            ...
            //Assert.IsType<OAuth2LoginRequest>(response);
        }
        ...
        public void GetOAuth2LogoutRequestTest()
        {
            ...
            //Assert.IsType<OAuth2LogoutRequest>(response);
        }
        ...
        public void GetTrustedOAuth2JwtGrantIssuerTest()
        {
            ...
            //Assert.IsType<TrustedOAuth2JwtGrantIssuer>(response);
        }
        ...
        public void IntrospectOAuth2TokenTest()
        {
            ...
            //Assert.IsType<IntrospectedOAuth2Token>(response);
        }
        ...
        public void ListOAuth2ConsentSessionsTest()
        {
            ...
            //Assert.IsType<List<OAuth2ConsentSession>>(response);
        }
        ...
        public void ListTrustedOAuth2JwtGrantIssuersTest()
        {
            ...
            //Assert.IsType<List<TrustedOAuth2JwtGrantIssuer>>(response);
        }
        ...
        public void OAuth2AuthorizeTest()
        {
            ...
            //Assert.IsType<ErrorOAuth2>(response);
        }
        ...
        public void Oauth2TokenExchangeTest()
        {
            ...
            //Assert.IsType<OAuth2TokenExchange>(response);
        }
        ...
        public void PatchOAuth2ClientTest()
        {
            ...
            //var response = instance.PatchOAuth2Client(id, jsonPatch);
            //Assert.IsType<OAuth2Client>(response);
        }
        ...
        public void RejectOAuth2ConsentRequestTest()
        {
            ...
            //var response = instance.RejectOAuth2ConsentRequest(consentChallenge, rejectOAuth2Request);
            //Assert.IsType<OAuth2RedirectTo>(response);
        }
        ...
        public void RejectOAuth2LoginRequestTest()
        {
            ...
            //string loginChallenge = null;
            //RejectOAuth2Request? rejectOAuth2Request = null;
            //var response = instance.RejectOAuth2LoginRequest(loginChallenge, rejectOAuth2Request);
            //Assert.IsType<OAuth2RedirectTo>(response);
        }
        ...
        public void SetOAuth2ClientTest()
        {
            ...
            //string id = null;
            //OAuth2Client oAuth2Client = null;
            //var response = instance.SetOAuth2Client(id, oAuth2Client);
            //Assert.IsType<OAuth2Client>(response);
        }
        ...
        public void SetOAuth2ClientLifespansTest()
        {
            ...
            //var response = instance.SetOAuth2ClientLifespans(id, oAuth2ClientTokenLifespans);
            //Assert.IsType<OAuth2Client>(response);
        }
        ...
        public void TrustOAuth2JwtGrantIssuerTest()
        {
            ...
            //var response = instance.TrustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer);
            //Assert.IsType<TrustedOAuth2JwtGrantIssuer>(response);
        }
    }
}
